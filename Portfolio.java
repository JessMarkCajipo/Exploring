...
public class Portfolio {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("==================^^=^^=================");
        System.out.println("`PORTFOLIO IN DATASTRUCTURES AND ALGORITHMS`");
        System.out.println("==================^^=^^=================");
            System.out.println("JESSMARKCAJIPO_BSIS202");
...
class Tree {
    public static void main(String[] args) {
        ...
        System.out.print("Enter the tangkay node: ");
        String tangkayData = scanner.nextLine();
        TreeNode<String> tangkay = new TreeNode<>(tangkayData);
        ...
        for (int i = 0; i < numChildren; i++) {
            System.out.print("Enter child " + (i + 1) + " for the tangkay: ");
            String childData = scanner.nextLine();
            tangkay.addChild(new TreeNode<>(childData));
        }
...
class BinaryTree {
    ...
    public static void main(String[] args) {
      ...
      tree.tangkay = new Node('P');
      tree.tangkay.left = new Node('G');
      tree.tangkay.right = new Node('W');

      // create child nodes of the left child ('G')
      tree.tangkay.left.left = new Node('C');
      tree.tangkay.left.right = new Node('K');
        
      // create child nodes of the left child ('C')
      tree.tangkay.left.left.left = new Node('A');
      tree.tangkay.left.left.right = new Node('E');
        
      // create child nodes of the left.right child ('K')
      tree.tangkay.left.right.left = new Node('I');
      tree.tangkay.left.right.right = new Node('M');

      // create child nodes of the right child ('W')
      tree.tangkay.right.left = new Node('S');
      tree.tangkay.right.right = new Node('Y');
        
      // create child nodes of the right.left child ('S')
      tree.tangkay.right.left.left = new Node('Q');
      tree.tangkay.right.left.right = new Node('U');
        
      // create child nodes of the right.right child ('Y')
      tree.tangkay.right.right.left = new Node('X');
      tree.tangkay.right.right.right = new Node('Z');

      // call method to count leaf nodes
      int leafNodes = countLeaf(tree.tangkay);
